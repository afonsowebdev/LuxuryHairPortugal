    ...
    <div className="flex flex-col gap-6">
      ...
      {tab === "contactos" ? (
        <div className="flex flex-col gap-3">
          {messages.length === 0 && (
            <div className="rounded bg-white p-10 text-center text-sm text-plum-dark/50 ring-1 ring-plum/10">
              Ainda não há mensagens de contacto.
            </div>
          )}
          {messages.map((m) => (
            <div key={m.id} className="rounded bg-white ring-1 ring-plum/10">
              <button
              ...
              >
                ...
                <button
                  ...
                  className="shrink-0 rounded p-2 text-plum-dark/40 hover:bg-red-50 hover:text-red-600 cursor-pointer"
