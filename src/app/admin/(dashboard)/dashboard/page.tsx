...
function QuickAction({
  ...
  return (
    <Link
      href={href}
      className="relative flex items-center gap-2.5 bg-white px-4 py-3 text-sm font-medium text-plum-dark ring-1 ring-plum/10 transition-colors hover:bg-plum-dark/5"
    >
            ...
            <div className="flex flex-col divide-y divide-plum/10">
              {bestSellers.map(({ product, qty }) => (
                ...
                >
                  ...
                  <span className="shrink-0 bg-plum-dark/5 px-2.5 py-0.5 text-xs font-semibold text-plum-dark/70">
                    {qty} vendidos
                  </span>
                </Link>
              ))}
            ...
            <div className="flex flex-col divide-y divide-plum/10">
              {lowStock.map((p) => (
                ...
                >
                  ...
                  <span className="shrink-0 bg-bordeaux/10 px-2.5 py-0.5 text-xs font-semibold text-bordeaux">
                    {p.stock} unid.
                  </span>
                </Link>
              ))}
