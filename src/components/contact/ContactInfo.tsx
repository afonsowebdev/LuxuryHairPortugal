  ...
  if (href) {
    return (
      <a
        ...
        className="group flex items-center gap-4 px-1 py-1 transition-colors hover:text-gold"
      >
        {content}
      </a>
    );
...
export function ContactInfo() {
  ...
  return (
    <div className="flex flex-col gap-8 bg-plum-dark px-7 py-8 text-cream shadow-lg sm:px-9 sm:py-10">
      <div>
