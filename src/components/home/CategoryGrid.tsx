        ...
        <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-5">
          {categories.map((category, i) => (
            <Link
              ...
              className={`group relative flex aspect-[3/4] flex-col justify-end overflow-hidden rounded shadow-md shadow-plum/10 ring-1 ring-plum/5 animate-fade-in-up lg:aspect-auto lg:h-[440px] ${
                i === 0 ? "lg:col-span-2" : ""
              }`}
