...
export function ProductForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      <div className="grid grid-cols-1 gap-4 bg-white p-6 ring-1 ring-plum/10 sm:grid-cols-2">
      ...
      <div className="flex flex-col gap-4 bg-white p-6 ring-1 ring-plum/10">
        ...
        {toLines(values.photos).length > 0 && (
          <div className="flex flex-wrap gap-3">
            {toLines(values.photos).map((url) => (
              <div
                key={url}
                className="relative h-20 w-20 shrink-0 overflow-hidden bg-plum-dark/5 ring-1 ring-plum/10"
              >
