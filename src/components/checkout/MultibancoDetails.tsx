...
function CopyField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-md bg-cream/60 px-4 py-3">
      <div>
...
export function MultibancoDetails({
  ...
  return (
    <div className="flex flex-col gap-3 rounded border-2 border-gold/40 bg-gold/10 p-6">
