    ...
    <label className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          {...props}
          className={`w-full border border-cream/25 bg-cream/10 py-3 pl-11 text-sm text-cream outline-none backdrop-blur-sm transition-colors placeholder:text-cream/40 focus:border-gold focus:bg-cream/20 focus:ring-2 focus:ring-gold/20 ${
